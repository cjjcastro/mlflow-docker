...
```
cd existing_repo
git remote add origin https://gitlab.com/mlops-system/mlops-mlflow.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/mlops-system/mlops-mlflow/-/settings/integrations)
